import SectionContainer, { BackgroundStyleTypes } from 'components/SectionContainer'

interface PageHeaderProps {
  headerTitle: string
  headerDescription?: string
  showProgress?: boolean
  headerColor: BackgroundStyleTypes
}
...
const PageHeader = ({
  ...
  headerDescription,
  showProgress = false,
  headerColor = 'white' as BackgroundStyleTypes,
}: PageHeaderProps) => {
  return (
    <>
      <SectionContainer backgroundStyle={headerColor}>
        <div className="relative border-b text-black">
          <div className=" relative py-5 sm:py-16">
            <div className="mb-3 mt-0 sm:mb-4">
              ...
              <h1 className="mb-0.5 text-2xl font-bold sm:mb-2 sm:text-4xl text-black">
                {headerTitle}
                <span className="relative top-0 sm:-top-1"> </span>
              </h1>
              <p className="text-sm text-gray-500 sm:text-lg">{headerDescription}</p>
            </div>
                ...
                >
                  <p className="flex text-sm transition-opacity duration-300" data-progress-nums="">
                    ...
                    <span className="md:hidden">
                      ...
                      <span data-progress-total="">123</span> Done
                    </span>
                  </p>
                  <div
